...
public class AgendamentoDAO {
    ...
    public boolean update(Agendamento agendamento){
        ...
        for (int i = 0; i < Banco.agendamento.size(); i++) {
            if(idSaoIguais((Agendamento) Banco.agendamento.get(i),agendamento)){
    ...
    public boolean delete(Agendamento agendamento){
        for (Object agendamentoLista : Banco.agendamento) {
            if(idSaoIguais((Agendamento) agendamentoLista,agendamento)){
